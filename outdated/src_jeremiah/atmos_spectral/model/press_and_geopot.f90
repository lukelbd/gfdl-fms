...
use constants_mod, only: grav, rdgas, rvgas, pi, radius, omega
...
subroutine compute_geopotential(t_grid, ln_p_half, ln_p_full, geopot_full, geopot_half, &
                                  surf_geo_factor, q_grid)

real, intent (in), dimension (:,:,:) :: t_grid, ln_p_half, ln_p_full
real, intent(out), dimension (:,:,:) :: geopot_full, geopot_half
real, intent (in)                    :: surf_geo_factor
...
geopot_half(:,:,num_levels+1) = surf_geopotential(:,:) * surf_geo_factor
...
subroutine compute_pressures_and_heights(t_grid, ps_grid, z_full, z_half, p_full, p_half, surf_geo_factor, q_grid)
...
call compute_geopotential(t_grid, ln_p_half, ln_p_full, z_full, z_half, surf_geo_factor, q_grid)
